...
export default function Home() {
  return (
    <div className="bg-slate-900 text-slate-50 min-h-screen px-4">
      ...
      <main className="space-y-4">
        <section className="text-slate-400 text-sm">
          ...
          <p>
            ...
            useless JavaScript. On the other hand, I understand that sometimes a
            complex website hard to do without a lot of JavaScript. I also use
            React sometimes.
          </p>
        ...
        <section>
          ...
          <ul>
            {[1, 2, 3].map((index) => (
              <li key={index} className="border-l-2 pl-3 relative">
                {/* Dot */}
                <div className="size-3 bg-green-700 rounded-full border-3 absolute top-7 -left-[7px]"></div>
          ...
          <ul>
            <li className="border-r-2 border-b-2 p-5 relative rounded-br-2xl">
              ...
              <p className="text-sm text-slate-400 mb-2 text-justify">
                Already at the age of 6, I was creating ‘programs’ in Excel and
                PowerPoint with interactive elements such as buttons.{" "}
